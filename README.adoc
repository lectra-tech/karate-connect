...
* match result.status == "OK"
* match result.data[0].properties == ... # output properties
* match result.data[0].body == ... # output string body
...
* match result.data.body == ... # output string body
----
