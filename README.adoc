...
It is a fat JAR with https://github.com/karatelabs/karate[Karate Core^] and extensions to connect to other systems:

* `karate-connect-standalone-<version>.jar`
...
[source,bash]
----
java -jar karate-connect-standalone-<version>.jar -Dextensions=<ext1>,<ext2>... <karate_args>
----
